    ...
    const commentContent = `
        ...
        <div class="bg-dark ml-3 p-2 rounded">
            ...
            <form class="reply-form mt-3" data-commentid='${comment._id}'>
                <div class="mb-3">
                    <label for="reply-name">Leave Your Name</lable>
                    <input class="form-input" name="reply-name" required />
                </div>
                <div class="mb-3">
                    <lable for"reply">Leave your Name</lablel>
...
function handleNewCommentSubmit(event) {
    ...
    const commentBody = $newCommenetForm.querySelector('#comment').value;
...
function handleNewReplySubmit(event) {
    ...
    const writtenBy = event.target.querySelector('[name=reply-name').values;
